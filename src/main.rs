...
impl Component for Model {
    ...
    fn update(&mut self, _ctx: &Context<Self>, _msg: Self::Message) -> bool {
        ...
        //Document::body().unwrap().class_list() = Document::body().unwrap().class_list().add("dark");
                                ...
                                <div class="dropdown">
                                    <div class="dropdown_inner">
                                        <ul class="anchor_nav">
                                            ...
                                            <li>{ if self.is_dark {"Dark"} else {"Light"}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="content">
                                    <div class="details">
                                        ...
                                        <div class="button">
                                            ...
                                            <div class="social">
                                                <ul>
                                                    <li><a href={github_url} target="_blank"><i class="icon-github-2"></i></a></li>
