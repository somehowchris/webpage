...
impl Component for ScrollProgressBar {
    ...
    fn update(&mut self, _ctx: &Context<Self>, msg: Self::Message) -> bool {
        match msg {
            ...
            Msg::Click => {
                self.window.scroll_to_with_scroll_to_options(web_sys::ScrollToOptions::new().top(0.0).behavior(web_sys::ScrollBehavior::Smooth));
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class={classes!(
                ...
                <a onclick={click}><span class="text" ref={self.text_ref.clone()} style={bottom}>{"To Top"}</span></a>
